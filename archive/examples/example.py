...
"""Example for usage of generator for artificial data synthetic_data_generator."""

from synthetic_data_generator import visualizer
from archive import synthetic_data_generator
